...
public:
  LineTrace()
  {
    ...
    sub= it.subscribe("camera", 1, &LineTrace::imageCallback, this);
  ...
  void imageCallback(const sensor_msgs::ImageConstPtr& msg)
  {
    try
    {
      ...
      sensor_msgs::ImagePtr msg = cv_bridge::CvImage(std_msgs::Header(), "bgr8", imgNormal).toImageMsg();
      pub.publish(msg);
    }
